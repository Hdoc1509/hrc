...
3](#option-3-use-babel-with-babel-plugin-import)
:::
...
<Steps>
   ...
   1. Install `vite-plugin-hrc-import`:
      ...
      <InstallCommand packages={["vite-plugin-hrc-import"]} syncKey={tabKey} isDev />
...
## Option 3: Use [`babel`](https://babeljs.io/) with [`babel-plugin-import`](https://github.com/umijs/babel-plugin-import)
