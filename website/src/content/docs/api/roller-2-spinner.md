---
title: Roller2Spinner API
description: API reference docs for the React Roller2Spinner component
---

## Import

```js
import { Roller2Spinner } from "@hrc/spinner";
```
...
The base styles for `<Roller2Spinner />` component.
