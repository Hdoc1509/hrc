...
:::note
As this is an Astro project, [`<ThemeSelect />` component of this
website][ThemeSelect] required to use a [`client directive`][client-directive]
...
[ThemeSelect]: https://github.com/Hdoc1509/hrc/blob/master/website/src/components/ThemeSelect.astro
